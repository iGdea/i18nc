      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        return _context.abrupt("return", i18ncDB.update(input));
                      ...
                      case 4:
                        ...
                        return _context.abrupt("return", loadDBFile(input));
                      ...
                      case 9:
                        ...
                        return _context.abrupt("return", loadDBFiles(input));
          ...
          case 3:
            ...
            return _context2.abrupt("return", extendDB(dataArr));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            return _context4.abrupt("return", Promise.map(files.sort(), function (file) {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            return _context5.abrupt("return", i18ncPO.parse(content));
...
function autoLoadDBSync(inputs) {
  ...
  var dataArr = inputs.map(function (input) {
    if ((0, _typeof2["default"])(input) == 'object') return i18ncDB.update(input);
    var stats = fs.statSync(input);
    if (stats.isFile()) return loadDBFileSync(input);else if (stats.isDirectory()) return loadDBFilesSync(input);else throw new Error('Input Is Not File Or Directory');
  });
