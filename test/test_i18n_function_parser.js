...
describe('#i18n_function_parser', function()
{
	...
	describe('#translateSubtreeAst2json', function()
	{
		it('#normal', function()
		{
			...
			requireAfterWrite('translate_data.json', JSON.stringify(result, null, '\t'));
		...
		it('#empty head', function()
		{
			...
			requireAfterWrite('translate_data_empty_head.json', JSON.stringify(result, null, '\t'));
	...
	it('#parse', function()
	{
		...
		requireAfterWrite('i18n_handler_example_output.json', result);
