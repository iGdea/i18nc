...
{
	var specialWords = ['中文0', '中文1', '2中文4中文5', '中文span', '中文span2', '中文span3', '中文2', '中文3', '中文key', '中文val', '再来', '2中', '我中文们', '一般不会吧', '中午呢', '中文呢？', 'I18N(中文)'];
	...
	it('#first', function()
	{
		...
		expect(info.specialWords).to.eql(specialWords);
