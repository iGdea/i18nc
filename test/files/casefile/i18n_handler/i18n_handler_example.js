module.exports = I18N;
function I18N(d,f,k){
	var a=I18N;var p=a.data||(a.data={});var e=(function(){return global.__i18n_lan__})(p);if(!f||!f.join){k=f;f=[]}if(e&&e.split){var g,b,h,c;if(a.L!=e){a.K='i18n_handler_example';a.V='a';a.D={
		"en-US": {
			"DEFAULTS": {
				"简体": "simplified",
				"空白": [],
