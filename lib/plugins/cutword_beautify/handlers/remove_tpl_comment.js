var debug = require('debug')('i18nc-core:removeTplComment');

exports.removeTplComment = removeTplComment;
function removeTplComment(lineStrings, value)
{
...
exports._commentIndexs = _commentIndexs;
/**
 * 将字符串中html注释index找出来
 * 忽略不成对的注释标签
 */
...
exports._resplitLineStringsByCommentIndexs = _resplitLineStringsByCommentIndexs;
/**
...
function _resplitLineStringsByCommentIndexs(lineStrings, commentIndexs)
{
	...
	if (!isCommentEmpety || tmpComment.length) throw new Error('Tpl Comment Is Not End');

	return result;
}


exports._addItemLackValue = _addItemLackValue;
/**
