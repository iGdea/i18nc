...
_.extend(ASTCollector.prototype,
{
	collect: function(ast, scopeType)
	{
		...
		return this._collectWidthScope(scope, ast);
	},
	_collectWidthScope: function(scope, ast)
	{
		...
		if (blockModifier)
		{
			switch(blockModifier.type)
			{
				...
				case BLOCK_MODIFIER.DEFAULT_SUBTYPE:
					var newScope = new ASTFunctionScope(ast);
					newScope.defaultSubtype = blockModifier.data;
					scope.subScopes.push(self._collectWidthScope(newScope, ast));
					return;
			}
		}
