...
var i18nTpl			= require('./i18n_function_tpl');
var astUtils		= require('./ast_utils');
var optionsUtils	= require('./options');
var i18nParser		= require('./i18n_function_parser');
var i18nGenerator	= require('./i18n_function_generator');
...
_.extend(I18NPlaceholder.prototype,
{
	...
	_updatePartialCode: function()
	{
		...
		var firstPart = this.completedCode.slice(this.orignalAst.range[0], json_ast_range[0]);
		var indent = /\n[\t ]*$/.test(firstPart) ? null :  '\t';
