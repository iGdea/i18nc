...
exports.defaults =
{
	...
	// js代码中，获取当前语言包的代码
	I18NhandlerTpl_GetGlobalCode	: 'typeof window == "object" ? window : typeof global == "object" && global',
	I18NhandlerTpl_LanguageVarName	: '__i18n_lan__',
...
exports.extend = function(obj)
{
	...
	if (!ret.isInsertI18NHandler)
	{
		ret.isClosureWhenInsertedHead = false;
	}

	// 直接设置为false
	// 避免生成无用的key
	if (ret.isMinFuncTranslateCode)
	{
		ret.isInjectAllTranslateWords = false;
	}
