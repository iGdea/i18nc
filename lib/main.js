...
module.exports = function(code, options)
{
	...
	var i18nPlaceholderNew = new I18NPlaceholder(codeTranslateWords, options);
	var fixIndex = 0;
	...
	i18nPlaceholders.forEach(function(i18nPlaceholder)
	{
		...
		funcTranslateWords[info.__FILE_KEY__] = extend(true, {},
				funcTranslateWords[info.__FILE_KEY__],
