...
module.exports = function(code, options)
{
	...
	collect.i18nHanlderAsts.forEach(function(item)
	{
		dealAst.push({type: 'i18nHandler', value: item});
	});

	if (!collect.i18nHanlderAsts.length && options.isInsertToDefineHalder)
	{
		collect.defineFunctionArgAsts.forEach(function(item)
		{
